    ...
    <div class="coluna">
      <div class="linha">
        ...
        <form action="cad.php" method="post">
          <div class="mb-3">
            <label for="nome" class="form-label"  style="color:black">Nome Completo</label>
            ...
            <label for="data" class="form-label" style="color:black">Data de Nascimento</label>
            <input type="date" class="form-control" name="data">

            <label for="email" class="form-label" style="color:black">Email</label>
            <input type="email" class="form-control" name="email">

            <label for="senha" class="form-label" style="color:black">Senha</label>
